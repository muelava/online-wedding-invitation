...
<!DOCTYPE html>
    ...
    <body>
          ...
          <video controls hidden autoplay>
            <source src="backsound/videoplayback.mp4">
        </video>
        <section class="hero">
            <div class="header">
       ...
       <section class="wish-box">
            <h1 class="header">Wish Box</h1>
            <div class="comment-section">
                <p class="comment-section__name-and-date" style="font-weight: bold;">Muelava, 12-June-2021</p>
                <p class="comment-section__comment">Happy Wedding..!!</p>
                <p class="comment-section__name-and-date"  style="font-weight: bold;">Yogi Teza, 11-June-2021</p> 
                <p class="comment-section__comment">Congratulations!!!</p>
            </div>
        </section>
      ...
      <section class="reservation">
            ...
            <form action="" method="post">
                <input type="text" name="name" class="name"placeholder="Nama Kamu"> <br>
                <select name="person" class="person">
                    <option value="one">1 orang</option>
                    <option value="two">2 orang</option>
                </select>
                <input type="text" name="phone-number" class="phone-number" placeholder="Nomor WhatsApp">

                <div class="radio-container radio-container1">
                    <input type="radio" id="choice1" name="gender" value="choice1">
                    <label for="choice1">Saya akan hadir</label><br>
                </div>
                <div class="radio-container radio-container2">
                    <input type="radio" id="choice2" name="gender" value="choice2">
                    <label for="choice2">Saya masih ragu</label><br>
                </div>
                <div class="radio-container radio-container3">
                    <input type="radio" id="choice3" name="gender" value="choice3">
                    <label for="choice3">Mohon maaf, saya tidak bisa hadir</label>
                </div>
        ...
        <div class="footer"> <a href="https://indomedia.my.id" target="_blank"></a> Powered by indomedia</div>
